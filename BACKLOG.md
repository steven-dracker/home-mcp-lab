...
- CC-HMCP-000001B — Operating model, conventions, and platform definition

---

## To-Do

- CC-HMCP-000001C — TBD (architect to define next task)
...
- Visibility gap register — VG-HMCP-* framework and first entries documenting what currently cannot be observed
...
- First ADR — ADR-HMCP-001: platform vs project separation decision
